...
<html lang="en">
  <head>
    ...
    <title><?php
        echo (empty($_GET['id'])) 
        ? ((strpos($_SERVER['REQUEST_URI'],'create')) ? "Agregando nuevo usuario de fabricante" : "Index")
        : ((strpos($_SERVER['REQUEST_URI'],'show')) ? "Detalles del registro del fabricante ".$_GET['id'] : "Actualizar registro ".$_GET['id'] );
    ?></title>
